...
unsafe extern "C" fn metaknight_special_n_spin_main(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    fighter.sub_shift_status_main(L2CValue::Ptr(metaknight_special_n_spin_main_loop as *const () as _))
}
...
unsafe extern "C" fn metaknight_special_n_spin_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub fn install(agent: &mut Agent) {
    agent.status(Main, *FIGHTER_METAKNIGHT_STATUS_KIND_SPECIAL_N_SPIN, metaknight_special_n_spin_main);
}