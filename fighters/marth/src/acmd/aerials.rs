...
unsafe extern "C" fn sound_attackairlw(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        PLAY_SE(agent, Hash40::new("se_marth_attackair_l01"));
    }
}
