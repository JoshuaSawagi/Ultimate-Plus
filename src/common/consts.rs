...
pub const FIGHTER_BANDANA_INSTANCE_WORK_ID_INT_ATTACK_HI4_EFFECT_HANDLE: LuaConst = LuaConst::new(0x100000D2);
pub const FIGHTER_BANDANA_INSTANCE_WORK_ID_INT_SPECIAL_S_STORE_FRAME: LuaConst = LuaConst::new(0x100000D3);
